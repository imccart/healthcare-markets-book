...
**Adverse selection** (@def-selection) occurs because individuals act on information about their own expected costs that insurers cannot perfectly observe or price. For example, individuals who anticipate higher medical expenses due to chronic conditions or recent diagnoses are more inclined to seek coverage, while healthier individuals may opt out if premiums seem high relative to their perceived risk. This self-selection can create serious challenges for insurers, since the higher concentration of high-cost enrollees increases claims and may lead to financial losses.
