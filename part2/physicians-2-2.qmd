...
Physicians again aim to maximize profits by optimizing the profit function, $\pi=n(NB)\left[R+(p_{s}-c)x\right]$. This maximization problem yields the following first order condition:
