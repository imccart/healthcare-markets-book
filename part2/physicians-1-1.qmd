...
Considering the impact of physician agency on healthcare spending, the Dartmouth Atlas of Health Care provides several ways of visualizing healthcare variation across different regions. As shown in @fig-variation, the U.S. experiences significant variation in health care utilization across different geographic areas.

::: {#fig-variation layout-ncol=2}

![](../figures/dartmouth_map.png){#fig-map}

![](../figures/dartmouth_dist.png){#fig-dist}
