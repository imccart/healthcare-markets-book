...
The explanation that survives is prices. For the same procedure, the same drug, or the same day in the hospital, the U.S. pays far more than other countries. @anderson2003 made this argument in an article titled "It's the Prices, Stupid," and a follow-up in the same journal, @anderson2019, reached the same conclusion with updated data. If those prices bought the best care in the world, that would be a defensible trade. As the mortality figures above show, they do not, at least not across the board.
