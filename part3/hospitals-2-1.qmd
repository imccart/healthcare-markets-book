...
If we instead assume that the hospital maximizes $\pi_{i,j}$ (e.g., the profit from insurer $i$), then this takes the form of a standard price-setting problem for a monopolistically competitive firm, illustrated in @fig-hosp-price.
