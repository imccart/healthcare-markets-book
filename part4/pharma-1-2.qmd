...
$$\frac{p^{*}_{c}}{p^{*}_{nc}} = \frac{\frac{1}{2} \left(\frac{a}{\alpha}+c\right)}{\frac{a+c}{2}} = \frac{a+\alpha c}{\alpha(a+c)} > 1$$

This result shows that the monopoly price under coinsurance is higher than the price without coinsurance whenever $\alpha < 1$, reaching a factor of $\frac{1}{\alpha}$ when marginal cost $c=0$. The presence of coinsurance amplifies the market power of the monopolist, allowing for higher prices compared to a setting without insurance.
...
$$\begin{align*} p_{1}^*(p_{2}) &= \frac{a + cp_{2} + b\,mc_{1}}{2b} \\
p_{2}^*(p_{1}) &= \frac{a + cp_{1} + b\,mc_{2}}{2b} \end{align*}$$
